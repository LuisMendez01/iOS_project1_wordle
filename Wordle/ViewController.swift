...
class ViewController: UIViewController {
  ...
  override func viewDidLoad() {
    ...
    // START YOUR CODE HERE
      keyboardController.didSelectString = { str in
          ...
          if str == DELETE_KEY {
              ...
              self.boardController.alertClosure = { flag in
                  
                  if flag {
                      let alert = UIAlertController(title: "Alert", message: "Word has been Guessed", preferredStyle: .alert)
                      alert.addAction(UIAlertAction(title: "OK", style: .default, handler: { action in
                          ...
                          @unknown default:
                              fatalError("Fatal Error in Main ViewController")
                          }
                      }))
    ...
    // Here you can change the viewController background color
